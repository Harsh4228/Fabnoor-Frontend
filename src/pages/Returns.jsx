      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100">
          ...
          <p className="text-gray-600 mb-6 text-lg">
            Products can be returned according to our communication with customer support.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4 p-4 bg-pink-50 rounded-lg">
              ...
              <p className="text-gray-700">Refund processed within 5–7 business days or as per our communication with customer support.</p>
            </div>
          </div>
        </div>
      </div>
