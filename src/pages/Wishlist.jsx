    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-xl mb-2">Your wishlist is empty ❤️</p>
          <p className="text-gray-400 text-sm mb-6">Add items you love to your wishlist</p>
          <Link 
            to="/collection"
          ...
          {wishlist.map((item, index) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-3 right-3 z-10 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-red-50 transition-all duration-300 group/btn"
              >
                <svg className="w-5 h-5 text-gray-600 group-hover/btn:text-red-500 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-4">
                <h2 className="font-semibold text-gray-900 mb-2 truncate group-hover:text-pink-500 transition-colors">
                  {item.productId.name}
                </h2>
